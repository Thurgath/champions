        ...
        view(vnode) {
            ...
            if (onEdit) {
                ...
                if (name) {
                    elements.push(
                        <div class="champion-section-text">
                            <b {...editableText('name')}>{ m.trust(editableValue(name)) }</b>
                        </div>
                    );
                }
                if (help) {
                ...
                if (description) {
                    elements.push(
                        <div class="champion-section-text champion-section-text-description">
                            <div {...editableText('description')}>{ m.trust(editableValue(description)) }</div>
                        </div>
                    );
                }
                if (heavy) {
                    elements.push(
                        <div class="champion-section-text">
                            ...
                            <span {...editableText('heavy')}>{ m.trust(editableValue(heavy)) }</span>
                        </div>
                    );
                }
                if (ranges) {
                ...
                if (youtube) {
                    elements.push(
                        <div class="champion-section-text">
                            ...
                            <span {...editableText('youtube')}>{ m.trust(editableValue(youtube)) }</span>
                        </div>
                    );
                }
                if (note) {
                    elements.push(
                        <div class="champion-section-text">
                            ...
                            <span {...editableText('note')}>{ m.trust(editableValue(note)) }</span>
                        </div>
                    );
                }
            }
