...
describe('FileLinesUpdater', () => {
    ...
    describe('.insert', () => {
        it('should throw error when searchString is not found', () => {
            const searchString = 'TYPE.NOTFOUND';
            expect(() => fileLinesUpdater.insert(searchString, '')).to.throw(Error, searchString);
        });
        it('should throw error when end of file marker is not found', () => {
    ...
    describe('.update', () => {
        it('should throw error when searchString is not found', () => {
            const searchString = 'TYPE.NOTFOUND';
            expect(() => fileLinesUpdater.update(searchString, '')).to.throw(Error, searchString);
        });
    });
});
