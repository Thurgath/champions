...
import ChampionSpotlightParser from '../../../dev/script/champion-update/champion-spotlight-parser.mjs';
...
describe('ChampionSpotlightParser', () => {
    ...
    describe('.getClassType', () => it('should return the expected class type for mutant', () => {
        expect(daniMoonstar.getClassType()).to.equal('MUTANT');
    }));

    describe('.getClassType', () => it('should return the expected class type for tech', () => {
        expect(shocker.getClassType()).to.equal('TECH');
    }));

    describe('.getClassType', () => it('should return the expected class type for cosmic', () => {
        expect(gorr.getClassType()).to.equal('COSMIC');
    }));

    describe('.getClassType', () => it('should return the expected class type for older mystic', () => {
        expect(magik.getClassType()).to.equal('MYSTIC');
    }));

    describe('.getClassType', () => it('should return the expected class type for older science', () => {
        expect(quake.getClassType()).to.equal('SCIENCE');
    }));

    describe('.getClassType', () => it('should return the expected class type for older skill', () => {
        expect(daredevilHellsKitchen.getClassType()).to.equal('SKILL');
    }));

    describe('.getAbilities', () => it('should return the expected abilities for Dani Moonstar', () => {
    ...
    describe('.getAbilities', () => it('should return the expected abilities for Shocker', () => {
    ...
    describe('.getAbilities', () => it('should return the expected abilities for Magik', () => {
    ...
    describe('.getStarLevels', () => it('should return the expected levels for Dani Moonstar', () => {
        expectStarLevels(daniMoonstar, 2, 6);
    }));

    describe('.getStarLevels', () => it('should return the expected levels for Shocker', () => {
        expectStarLevels(shocker, 2, 6);
    }));

    describe('.getStarLevels', () => it('should return only 2-star for Magik', () => {
        expect(magik.getStarLevels()).to.have.all.keys(2);
    }));

    describe('.getStarLevels', () => it('should return the expected levels for Quake', () => {
        expectStarLevels(quake, 2, 5);
    }));

    describe('.getStarLevels', () => it('should return the expected levels for Gorr', () => {
        expectStarLevels(gorr, 2, 7);
    }));

    describe('.getName', () => it('should return Dani Moonstar', () => {
        expect(daniMoonstar.getName().fullName).to.equal('Dani Moonstar');
    }));

    describe('.getName', () => it('should return Shocker', () => {
        expect(shocker.getName().fullName).to.equal('Shocker');
    }));

    describe('.getName', () => it('should return Magik', () => {
        expect(magik.getName().fullName).to.equal('Magik');
    }));

    describe('.getName', () => it('should return Quake', () => {
        expect(quake.getName().fullName).to.equal('Quake');
    }));

    describe('.getName', () => it('should return Gorr', () => {
        expect(gorr.getName().fullName).to.equal('Gorr the God Butcher');
    }));

    describe('.getName', () => it('should return Daredevil', () => {
